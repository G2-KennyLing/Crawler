let vm,requestModule,Debug;_34e‍.x([["requestCloudflare",()=>requestCloudflare],["default",()=>requestCloudflare]]);_34e‍.w("vm",[["default",["vm"],function(v){vm=v}]]);_34e‍.w("request",[["default",["requestModule"],function(v){requestModule=v}]]);_34e‍.w("debug",[["default",["Debug"],function(v){Debug=v}]]);
...
function solveChallenge(response, body, options, callback) {
  setTimeout(()=>{
    ...
    try {
      options.qs.jschl_answer = (_34e‍.u(eval(_34e‍.c(challenge))) + response.request.host.length);
    } catch (err) {
